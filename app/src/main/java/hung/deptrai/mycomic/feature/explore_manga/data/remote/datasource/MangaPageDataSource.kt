...
interface MangaPageDataSource {
    ...
    suspend fun fetchCustomList(listId: String): Result<hung.deptrai.mycomic.core.data.remote.dto.wrapper.JsonFewestResponse<hung.deptrai.mycomic.core.data.remote.dto.wrapper.DTOject<hung.deptrai.mycomic.core.data.remote.dto.ListAttributesDto>>, DataError.Network>
