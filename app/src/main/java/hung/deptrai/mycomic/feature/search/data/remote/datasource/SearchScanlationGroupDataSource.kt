...
interface SearchScanlationGroupDataSource {
    suspend fun getScanlationGroupByTitle(title: String): ResultWrapper<JsonResponse<hung.deptrai.mycomic.feature.search.data.dto.scanlationGroup.ScanlationGroupDTO>>
}